function stampaOffertaV2(tipo_opportunita, id, yy, nome, cognome, indirizzo, telefono, email, numero_moduli, numero_inverter, marca_moduli, 
...
var offertaStandard = '10HvhPMSPYG-vG-4r4C6Bd6cizT0YuZLMfQ9_smgTOds'; //v1
var offertaMateriale = '1gMJGZZA7LwdugXKEFTK5LbJU2iiIIs6Ee5zBnlW81es'; 
var offertaConLayout = '1dOsSzOQa30u7I2Z4FnU0guxiilO_VmsEjZ23UIrB1d0'; //v1
...
'{{percentuale_risparmio}}': new Intl.NumberFormat('it-IT', { minimumFractionDigits: 0, maximumFractionDigits: 0 }).format(percentuale_risparmio),
...
/* SOSPESO FINO A OFFERTA V2 ULTIMATA
